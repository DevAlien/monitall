...
import { Calendar } from "@monitall/ui/calendar";
import {
  Command,
  CommandEmpty,
  CommandGroup,
...
type MonitorFormValues = z.infer<typeof monitorCreateSchema>;

// This can come from your database or API.
const defaultValues: Partial<MonitorFormValues> = {
  // name: "Your name",
...
export function AccountForm() {
  ...
  function onSubmit(data: MonitorFormValues) {
    toast({
